...
const {douyinNews} = storeToRefs(newsMain)
newsMain.getDouyin();
</script>

<template>
  <div class="newsHeader">
    <span class="mainContent">{{douyinNews.title}}({{douyinNews.subtitle}})</span>
    <span class="youDing">更新时间:{{douyinNews.update_time}}</span>

  </div>

  <ul class="contentGe" v-for="(item) in douyinNews.data" :key="douyinNews.index">
